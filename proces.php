...
try {
    ...
    if ($_POST['csrf_token'] === $_SESSION['csrf_token']) {
        ...
        $stmt = $conn->prepare("INSERT INTO payment_tickets (username, fullname, email, phone, image1, image2, image3) VALUES (:username, :fullname, :email, :phone, :image1, :image2, :image3)");
